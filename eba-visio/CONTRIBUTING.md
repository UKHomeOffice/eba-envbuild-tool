...
3. Increase the version numbers, using Git tagging, to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
