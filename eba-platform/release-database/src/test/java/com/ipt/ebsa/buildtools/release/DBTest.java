package com.ipt.ebsa.buildtools.release;
...
import com.ipt.ebsa.buildtools.release.manager.GlobalConfig;
...
public class DBTest {
	...
	protected static final ConnectionData connectionData = new ConnectionData() {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			connectionManager.initialiseConnection(System.out, connectionData);
			
			entityManager = connectionManager.getManager();
		
			GlobalConfig.setSharedConnectionData(connectionData);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
