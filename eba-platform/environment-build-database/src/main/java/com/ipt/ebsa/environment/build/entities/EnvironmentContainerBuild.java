...
/**
 * The persistent class for the environmentcontainerbuild database table.
 * 
 */
@Entity
@NamedQuery(name="EnvironmentContainerBuild.findAll", query="SELECT e FROM EnvironmentContainerBuild e")
public class EnvironmentContainerBuild implements DBEntity {
	...
	public EnvironmentContainerBuild() {
	}
	...
	public String toString() {
		...
		.append("environmentcontainerdefinitionid", environmentcontainerdefinition.getId()).toString();
	}
}